<template>
  <div class="px-2 my-4 overflow-y-auto text-white md:my-8 md:px-0 grid-cols-4 gap-4 space-y-2 md:space-y-0 md:grid">
    <ul
  ...
  data () {
    return {
      paragraphs: [
        ...
        {
          text: 'À la suite de cette formation, mais qui s\'inscrit également dans son cadre, j\'ai effectué un stage de 3 mois en entreprise à Alstom (au sein de A6K à Charleroi). Cette formation m\'a permis d\'en découvrir davantage dans le monde du web devs, Bootstrap pour le projet sur lequel j\'ai participé, mais également VueJS, TailwindCSS, AlpineJS, et pleins de framework.',
          class: 'col-span-3'
        },
        {
